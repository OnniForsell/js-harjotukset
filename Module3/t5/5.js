...
for (let i = 0; i !== picArray.length; i++){
  ...
  itemH.innerText = picArray[i].title

  let itemFig = document.createElement('figure')

  let itemImg = document.createElement('img')
  itemImg.src = picArray[i].image.medium
  itemImg.alt = picArray[i].title

  let itemCaption = document.createElement('figcaption')
  itemCaption.innerText = picArray[i].caption

  let itemDesc = document.createElement('p')
  itemDesc.innerText = picArray[i].description

  item.appendChild(itemH)
  itemFig.appendChild(itemImg)
  itemFig.appendChild(itemCaption)
